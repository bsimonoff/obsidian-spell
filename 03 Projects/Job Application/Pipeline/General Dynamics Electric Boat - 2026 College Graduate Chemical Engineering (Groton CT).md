...
**Position:** 2026 College Graduate - Chemical Engineering  
**Company:** General Dynamics Electric Boat  
...
Chemical engineers at Electric Boat work on designs for the next class of submarine (Virginia and Columbia class), troubleshoot deckplate issues with building/testing submarines, participate in design reviews, and grow alongside experienced mentors.

### Key Responsibilities
- Participate in submarine design and engineering reviews
- Support manufacturing and construction of Virginia and Columbia-class submarines
- Troubleshoot production/assembly issues on the deckplate
- Apply chemical engineering principles to marine propulsion, materials, and systems
- Collaborate with cross-functional engineering teams (materials, mechanical, electrical, controls)
...
**Direct apply URL:** Available on the following platforms (may require account creation):
...
1. **Pull GD careers page:** Confirm role is still listed (as of 2026-07-26, it is).
2. **Check your eligibility:** Can you get a security clearance? (most new grads can)
3. **Draft/tailor cover letter:** Emphasize:
   - Interest in submarine design/marine engineering
   - Process engineering fundamentals (thermodynamics, materials, controls)
   - Willingness to learn & troubleshoot in high-stakes manufacturing
4. **Apply through ICIMS portal** (most direct path).
5. **Update this file + [[Application Tracker.md]]** when submitted.

---

## Contact / Recruiter

If you have questions before applying, try reaching out to Electric Boat recruiting through LinkedIn or the GD Careers portal. New-grad programs usually have dedicated recruiters.
