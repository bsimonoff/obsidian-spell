...
**Position:** Entry Level Chemical Engineer (various titles: Process Engineer I, Chemical Engineer I, Manufacturing Engineer I)  
**Company:** Eastman Chemical Company (Tier-1 specialty chemical producer)  
**Key Locations:**
- Kingsport, Tennessee (headquarters; largest site)
- Longview, Texas
- Beaumont, Texas
- Charleston, South Carolina
- Other US locations (varies by opening)

**Employment type:** Full-time, salaried  
**Openings:** 6+ across the company (as of July 2026)  

---

## What They're Looking For

Eastman is a global specialty chemical company producing advanced materials for consumer, industrial, and specialty markets (coatings, adhesives, sealants, engineered materials, fibers, etc.). Entry-level roles typically support process engineering, manufacturing, quality, or plant operations.

### Typical Responsibilities (Process/Manufacturing Engineer I)
- Operate or support chemical manufacturing processes (reactors, distillation, crystallization, etc.)
- Monitor and record process parameters (temperature, pressure, flow, composition)
- Troubleshoot production issues; identify and implement improvements
- Collaborate with operations, quality, and engineering teams
- Contribute to continuous improvement projects (Lean, Six Sigma initiatives)
- Support maintenance and capital projects
- Apply chemistry and engineering fundamentals to real-world manufacturing

### Requirements
- **Bachelor of Science in Chemical Engineering** (graduating or recent graduate 2026)
- Strong fundamentals in thermodynamics, unit operations, process control, material science
- Ability to work in a fast-paced manufacturing environment
- Problem-solving and analytical mindset
- Teamwork and communication
- Willingness to work rotating shifts (some facilities require 24/7 coverage)
...
**Signing bonus:** Typically $2–5k (negotiable for top candidates)

**Benefits:**
- Comprehensive health insurance (medical, dental, vision)
- 401(k) with company match (6% typical)
- Defined benefit pension (rare in modern manufacturing; Eastman still offers this!)
- Tuition reimbursement / education assistance
- Paid time off + holidays + sick leave
- On-site gym/wellness (at major facilities)
- Career development programs (mentorship, technical certifications)
- Shift differential pay (if rotating shifts required)

**Relocation assistance:** Available for non-local hires (housing, moving costs)
...
✅ **Salary competitive:** $67–95k meets your $70k+ target

---

## Potential Concerns

⚠️ **Shift work:** Many Eastman facilities operate 24/7; entry-level roles may require rotating shifts (8-hour, 12-hour, or weird schedules). Verify schedule in interviews.  
⚠️ **Location:** Most sites are in smaller towns (Kingsport TN, Longview TX, Beaumont TX, Charleston SC). Not ideal if you want major metro vibe. However:
...
⚠️ **Chemical manufacturing environment:** You'll be in plants with heat, noise, industrial hazards. PPE required. Not for everyone.  
⚠️ **Broad salary range:** Glassdoor shows $67–130k, but entry-level is lower end ($67–80k). Don't assume upper range.  
⚠️ **Industry maturity:** Specialty chemicals is mature (not as fast-growing as tech/biotech); career growth is steady but not explosive.
...
| **Online application** | Straightforward; 10–15 min |
| **Initial phone screen** | 1–2 weeks |
| **Technical phone interview** | Week 2–3 (process questions, problem-solving) |
| **On-site or final interview** | Week 3–4 (if selected; may require travel to facility) |
| **Offer** | Week 4–5 |
| **Start date** | Flexible; negotiate for June–August 2026 |

---

## Research Checklist Before Applying

- [ ] Identify which **location you prefer** (or are flexible on). Check each facility on Google Maps (traffic, cost of living, nearby cities).
...
- [ ] **Relocation willingness:** Decide whether you're comfortable in a smaller city for 1–2 years (career building investment).
...
- Understanding of Eastman's products/markets (specialty materials)
- Willingness to work in an industrial environment
- Enthusiasm for problem-solving and continuous improvement
- Long-term mindset (you see this as a career, not a stepping stone)
...
**If you get an offer:**
- Typical entry-level offer: $68–78k base
...
## Location Deep-Dive (Choose Your Preference)

### Kingsport, Tennessee (Headquarters, largest site)
- **Vibe:** Small city (50k+), growing professional community
- **Cost of living:** Low ($1,200–1,400 rent for 1BR)
...
- **Cost of living:** Low ($1,100–1,300 rent)
...
- **Cost of living:** Moderate ($1,400–1,700 rent), but beautiful
...
- **Cost of living:** Low ($1,000–1,200 rent)
- **Proximity to:** Gulf Coast beach (1 hr), Houston (1.5 hrs)
- **Culture:** Petrochemical town; industrial, tight-knit engineering community

**Recommendation:** If you want urban energy and growth, pick **Charleston**. If you want lowest cost and traditional engineering culture, pick **Kingsport**. If you're open to Texas, **Longview** splits the difference.

---

## Next Steps

1. **Choose 1–3 preferred locations** (or apply to all initially; narrow after phone screen).
...
4. **Confirm each posting is live** (check date posted; within last 2–4 weeks is good).
5. **Read 5–10 Glassdoor reviews** (focus on shift schedules, work/life balance, new grad treatment).
...
- You're willing to relocate to a smaller city for 1–2 years
...
**Skip Eastman if:**
- You're set on Denver, Seattle, NYC, or Chicago (and won't relocate)
- You want a fast-paced startup vibe
- You're uncomfortable with possible shift work
- You want to be in a major tech/innovation hub immediately

---

**Last verified:** 2026-07-26  
**Next verification due:** 2026-08-09 (check careers portal for new postings every 2 weeks)
...
- ZipRecruiter salary data: $67k–$130k (entry-level = $67–85k)
