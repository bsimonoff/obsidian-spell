...
- [ ] Confirm TaskNotes has created the default `.base` files in `06 Scheduling/Views/`.
- [[the command palette and run TaskNotes Open tasks view]]
...
- Duplicate `06 Scheduling/Views/tasks-default.base` and make a view for one project.
